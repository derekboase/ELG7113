...
while(k<length(t)-2)
    ...
    y(ki+2)= (1/(1+b0*theta2(ki+1)/Ts))*(-a1*y(ki+1)-a2*y(ki)+b0*(theta1(ki+1)*(y(ki+1)-uc((k+1)*Ts))+theta2(ki+1)*y(ki+1)/Ts)+b1*(theta1(ki)*(y(ki)-uc(k*Ts))-theta2(ki)*((y(ki+1)-y(ki))/Ts)));
